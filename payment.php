  ...
  if($isUpdated==1){
   // echo " Payment status Updated ";
    ...
    if($booked_slots){
      ...
      $s10 = $booked_slots['s10'];

      $s11 = $booked_slots['s11'];

      $s12 = $booked_slots['s12'];

      $s13 = $booked_slots['s13'];

      $s14 = $booked_slots['s14'];

      $s15 = $booked_slots['s15'];

      $s16 = $booked_slots['s16'];

      $s17 = $booked_slots['s17'];

      $s18 = $booked_slots['s18'];

      $s19 = $booked_slots['s19'];

      $s20 = $booked_slots['s20'];

      $s21 = $booked_slots['s21'];

      $s22 = $booked_slots['s22'];

      $s23 = $booked_slots['s23'];

      $s24 = $booked_slots['s24'];
   ...
   if($booked_slots==1){
    ...
    $response["success"] = FALSE;
     ...
     // echo "SLOTS NOT UPDATED";
                 ...
                 /*$booked_slots = $db->updateSlotBooking($date,$s1,$s2,$s3,$s4,$s5,$s6,$s7,$s8,$s9,$s10,$s11,$s12,$s13,$s14,$s15,$s16,$s17,$s18,$s19,$s20,$s21,$s22,$s23,$s24);
                 ...
                 if($booked_slots==1){
                  ...
                  /*$booked_slots = $db->slotBooking($date,$s1,$s2,$s3,$s4,$s5,$s6,$s7,$s8,$s9,$s10,$s11,$s12,$s13,$s14,$s15,$s16,$s17,$s18,$s19,$s20,$s21,$s22,$s23,$s24);*/
