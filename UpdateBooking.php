...
/*
This file is for updating the booking  
*/
...
/*
Get all the parameter and assign variable 
*/
    ...
    else if($lab_number==2){ //if this is SPM lab 
    ...
    else if($lab_number==3){ //this is XRD lab
